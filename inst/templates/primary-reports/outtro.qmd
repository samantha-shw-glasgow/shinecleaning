...
-   How confident at interpreting health and wellbeing data?
-   If using more than one data source to track and monitor health and
    wellbeing in your , are they compatible and do staff confidently
...
-   Will a smaller group be responsible for working on the whole report
    ...
    groups in the or will the whole report be shared with everyone
    fully?

## Consider the context: {#consider-the-context .col .s12}

-   How representative are the data of the surveyed? If 80% of
    participated that is a very different picture to 20% of taking part.

-   Have you considered the number of taking part? If a small number of
...
-   When did take part ? Was it during an assessment time? When took
    part may also influence the results.

-   When comparing results to the SHINE national data Scottish HBSC
    national averages , consider:
    ...
    -   The wider context may influence results, such as gender balance,
        resources and levels of deprivation which will impact results.
:::

::: page
## Reflecting on the data: {#reflecting-on-the-data .col .s12}

-   To what extent do the data provide evidence of key issues for or
...
-   For the life happiness questions and the Social and Emotional Health
    survey-are there some areas in which scores are lower?
-   Are there particular patterns in data? For example, more negative
    outcomes across a number of measures ?

## Working together: {#working-together .col .s12}

-   Have we shared the SHINE data with the wider school community to
    include staff, pupils and parents to underpin a whole-school
    approach to HWB?

    -   Remember, may be best placed to explain and interpret the data
        they provided.

-   When considering the SHINE data, do a committee of stakeholders from
    different parts of the community take part in identifying HWB
