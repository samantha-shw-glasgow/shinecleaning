...
stakeholders in the `r ifelse(is_la_report, paste0(cluster_label, " HWB"), "school")` community. It is hoped that the ensuing discussions and
...
-   How confident `r ifelse(is_la_report, paste0("is the ",  cluster_label, " HWB team"), "are staff, parents and pupils")` at interpreting
    health and wellbeing data?
-   If using more than one data source to track and monitor health and
    wellbeing in your `r ifelse(is_la_report, cluster_label, "school")`, are they compatible and do staff confidently
...
-   Will a smaller group be responsible for working on the whole report
    ...
    groups in the `r ifelse(is_la_report, cluster_label, "school")` or will the whole report be shared with everyone
    fully?
...
-   How representative are the data of the `r ifelse(is_la_report, "young people", "school roll or the year group(s)")` surveyed?
    If 80% of `r ifelse(is_la_report, paste0("all young people in the ", cluster_label), "pupils")` participated that is a very
...
-   When comparing `r ifelse(is_la_report, paste0("the ", cluster_label), "your school")` results to the
    SHINE national data and/or Scottish HBSC national averages, consider:
    ...
    -   The wider `r ifelse(is_la_report, cluster_label,
...
-   To what extent do the data provide evidence of key issues for
    `r ifelse(is_la_report, paste0("the ", cluster_label), "my
...
-   Have we shared the SHINE data with the wider school
    community`r ifelse(is_la_report, paste0("? Can we support schools to apply a whole-school approach to mental health in a uniform way across the ",  cluster_label, "? Would additional training sessions be useful for this"), "")` to include staff, pupils and parents to underpin
...
-   When considering the SHINE data, do a committee of stakeholders from
    different parts of the `r ifelse(is_la_report, cluster_label, "school")` community take part in identifying HWB
