...
csl: ../styling/nature.csl
---

# [Acknowledgements]{.conh2} {#acknowledgements .col .s12 .report style="margin-bottom:0.5rem !important;"}
...
the Good Childhood Index. We also thank colleagues based at the Public
Health Research Facility at the MRC/CSO Social and Public Health
Sciences Unit (University of Glasgow) for their work on developing the
online survey and reporting portal. The SHINE project was originally
funded by the MRC Mental Health Data Pathfinder (2018-2021) and is now
funded by Medical Research Council core funding to Social and Public
Health Sciences Unit at the University of Glasgow with contributions
from some individual local authorities.

\newpage

# INTRODUCTION {#introduction .col .s12 .report}

Welcome to your Scottish Schools Health and Wellbeing Improvement
Research Network (SHINE) `r ifelse(is_la_report, "Local Authority", "school")` report on pupil mental health. Within this
report you will find your `r ifelse(is_la_report, "Local Authority\'s", "school\'s")` results to the SHINE Pupil Mental
...
aggregate data by gender and year groups to help identify trends or
patterns. It can also be used to:

-   Identify the main mental health and wellbeing issues affecting your
    `r ifelse(is_la_report, "young people as part of the wider community", "pupils and whole school community")`
...
-   Shape your `r ifelse(is_la_report, "Local Authority", "school")` improvement plan`r ifelse(is_la_report, " and staff programme", "")`
-   Promote pupil voice and shared decision-making
    `r ifelse(is_la_report, "as part of the whole-school approach strategy across the schools in the Local Authority", "")`
...
reflective questions to `r ifelse(is_la_report, "look at","consider")` 
when reviewing your `r ifelse(is_la_report, "Local Authority\'s", "school\'s")` 
...
The report is confidential`r ifelse(is_la_report, " and", ", only")` provided to your `r ifelse(is_la_report, "Local Authority", "school")` SHINE
representative`r ifelse(is_la_report, "", " and if requested, the health and wellbeing lead within your local authority")`. However, we
...
# MENTAL HEALTH AND WELLBEING {#mental-health-and-wellbeing .col .s12 .report .scrollspy}
...
to control or adapt to the adverse circumstances we face."* &nbsp; @scotlands_public_health_priorities
...
## Subjective Wellbeing {#mhw-sw .col .s12}
...
they inhabit and how they see themselves."* &nbsp; @childrens_society_2019
...
substance use, depression, fighting and delinquency. @lippman2014 In contrast, high
...
lower psychopathological externalising and internalising behaviour. @huebner2004
Young people with high subjective wellbeing have more favourable
academic, social and physical health outcomes. There is also evidence it
serves as a buffer against stressful life events and is a significant
factor in determining an individual's resilience to adverse life
circumstances.

## Mental health problems {#mhw-mhp .col .s12}
...
years old have a mental health condition. The most prevalent conditions
...
difficulties. There is evidence to suggest that emotional disorders are
increasing, particularly amongst girls.

Emotional disorders may impact on an adolescent\'s functioning for
example at school and in social situations. Those with mental health
problems are more likely to have poorer general health, lower
self-esteem and overall wellbeing. Many mental health problems persist,
...
in adulthood. At the same time, it is a period of vulnerability; nearly
half of all lifetime mental health conditions occur by 14 years old.
...
functioning and adaption. Those with no mental health problems and high
...
## Positive Mental Health {#mhw-pmh .col .s12}
...
wellbeing, spiritual wellbeing and physical health. It is when an
...
being able to establish positive relationships and helping others.

Positive mental health focuses on building on strengths and developing
resilience rather than focusing on deficits. It asserts that is possible
to develop skills and traits and thereby improve overall wellbeing. In
...
::: page
# Measuring Mental Health in the SHINE survey {#mhw-mmh .col .s12 .report}

## Subjective Wellbeing {#subjective-wellbeing .col .s12}
...
of satisfaction, which may indicate that additional support is required.

## Mental health problems {#mental-health-problems .col .s12}
...
## Positive Mental Health {#positive-mental-health .col .s12}

[***Social Emotional Health Survey (SEHS):***]{.shine2} This is a
20-item measure of "covitality", which is the co-occurrence of multiple
positive psychological traits of gratitude, optimism, zest and
persistence. When these traits co-occur (covitality) they are associated
with increased resilience, pro-social behaviour and school engagement
and satisfaction. The traits are seen to be related to different aspects
...
form part of the "covitality" score but there is an association between
high levels of pro-social behaviour and high levels of covitality.
...
and the overall covitality score have improved, following interventions.

## Factors influencing adolescent mental health {#mhw-amh .col .s12}
...
factors and how they interact. Contextual factors may influence or be a
...
environment, community and structural.
...
as housing and socio-economic status.

\

## Diagram 1: Factors influencing adolescent mental health {#diagram-1-factors-influencing-adolescent-mental-health .col .s12}
...
::: page
## School and adolescent mental health {#mhw-samh .col .s12}
...
effects of other social factors.
...
an important part in adolescent wellbeing. There is some evidence to
suggest that school connectedness serves as a protective factor against
risk behaviours and is an important determinant of adolescent mental
health. In particular, school connectedness is associated with healthier
behaviours such as being a less frequent smoker and cannabis user, less
likely to binge drink and more likely to meet physical activity
guidelines, as well as having fewer depressive symptoms. Better
...
report depressive symptoms and lower life satisfaction.

:::

::: {#understand .col .s12 .lr_zero .section .scrollspy}
::: page

# Understanding the data in this report {#understanding-the-data-in-this-report .col .s12 .report style="margin-bottom:1rem !important;"}

::: {.col .s12}
-   All figures show results for all pupils in your
    `r ifelse(is_la_report, "Local Authority", "school")`
    combined.
    This is due to the small number of pupils participating in the
    survey.
    Where we have enough responses, we will also show results by
    individual year and gender and/ or banded year groups and gender.
...
![](../img/figure_understanding_all.svg)
