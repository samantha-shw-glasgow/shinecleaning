...
(2018-2021) then by Medical Research Council core funding to the Social
and Public Health Sciences Unit at the University of Glasgow. SHINE is now funded
by reserach grant awards with contributions from some individual local authorities.
...
if (params$gender_split) {
  knitr::include_graphics("../img/figure_understand.png")
} else {
  knitr::include_graphics("../img/figure_understanding_all.png")
}
```
