...
their health was \'excellent\' or \'good\'`r if(params$gender_split){paste0(" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-health) shows the responses to this question from all pupils", ifelse(is_la_report, " in your Local Authority", " in your school"))}`.
...
percentage of pupils who like school \'a lot\' or \'a bit\'`r if(params$gender_split){paste0(" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch1) shows the responses to this question from all pupils", ifelse(is_la_report, " in your Local Authority", " in your school"))}`.
...
lot\' or \'some\' pressure`r if(params$gender_split){paste0(" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch2) shows the responses to this question from all pupils", ifelse(is_la_report, " in your Local Authority", " in your school"))}`.
...
Figure \@ref(fig:bar-sch3) shows the proportion of pupils in your `r ifelse(params$is_la_report, "Local Authority", "school")` who responded they
\'always\' or \'often\' feel confident`r if(params$gender_split){paste0(" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch3) shows the responses to this question from all pupils", ifelse(is_la_report, " in your Local Authority", " in your school"))}`.
