...
```{r, tab.cap="Pupil self-rated health", eval=params$gender_split}
...
```{r tab-sch1, tab.cap="How much pupils liked school", eval=params$gender_split}
...
```{r tab-sch2, tab.cap="How pressured pupils feel by schoolwork", eval=params$gender_split}
...
```{r tab-sch3, tab.cap="How often pupils feel confident", eval=params$gender_split}
