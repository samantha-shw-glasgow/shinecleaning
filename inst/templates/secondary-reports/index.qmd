...
input_data |>
  ...
  bar_mean_single(hbsc_data = get_hbsc_score(classes, "asw_score"), ymax = 60)
...
```{r tab-loneliness, tab.id="tab-loneliness", tab.cap.pre="Table", tab.cap="How often pupils feel lonely", eval=FALSE}
