...
percentage of pupils who like school \'a lot\' or \'a bit\' compared with the HBSC Scotland national average.  `r if(params$gender_split){"Table \\@ref(tab:tab-sch1) shows the responses to this question from all pupils."}`
...
lot\' or \'some\' pressure compared with the HBSC Scotland national average. `r if(params$gender_split){"Table \\@ref(tab:tab-sch2) shows the responses to this question from all pupils."}`
...
\'always\' or \'often\' feel confident compared with the HBSC Scotland national average. `r if(params$gender_split){"Table \\@ref(tab:tab-sch3) shows the responses to this question from all pupils."}`
