...
Figure \@ref(fig:bar-risk-depression) shows the proportion of those that score 28 or less and are classified as 'at risk of depression'. Note that those at risk of depression are also included in the Figure \@ref(fig:bar-wellbeing), showing low mood.
...
fours areas are then summed to create a total score on the SDQ (Figure
XXX) The SDQ also measures pro-social behaviour (Figure XXX). For more
information on the SDQ, see page 7.

```{r bar-cat-emot-cond-hyp-peer}

```

```{r bar-elevated-prosoc}
