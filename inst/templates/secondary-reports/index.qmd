...
Table \@ref(tab:tab-response) shows the number of pupils invited to take part, the number who did not take part (this includesopt-outs and absences) and the overall response rate for the survey in your `r ifelse(is_la_report, "area", "school")`.
...
```{r bar-cat-emot-cond-hyp-peer, fig.cap="SQD scores"}
...
percentage of pupils who like school \'a lot\' or \'a bit\'`r if(params$gender_split){" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch1) shows the responses to this question from all pupils."}`.
...
lot\' or \'some\' pressure`r if(params$gender_split){" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch2) shows the responses to this question from all pupils."}`.
...
\'always\' or \'often\' feel confident`r if(params$gender_split){" compared with the HBSC Scotland national average. Table \\@ref(tab:tab-sch3) shows the responses to this question from all pupils."}`.
...
most or all of the time. `r if(params$gender_split){"Table \\@ref(tab:tab-loneliness) shows the responses to this question from all pupils."}`
...
```{r tab-loneliness, tab.id="tab-loneliness", tab.cap.pre="Table", tab.cap="How often pupils feel lonely", eval=params$gender_split}
...
Figure \@ref(fig:bar-beleif-others)
shows the average
