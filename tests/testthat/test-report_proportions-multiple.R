...
describe("report multiple proportions", {
  ...
  expected_p6 <- tibble::tribble(
    ~gender, ~class, ~denom, ~var, ~n, ~labels, ~prop, ~censored,
    "Boys", "P6", 4, "health1", 2, "Health var 1", 0.5, TRUE,
    "Boys", "P6", 4, "health2", 1, "Health var 2", 0.25, TRUE,
    "Girls", "P6", 4, "health1", 4, "Health var 1", 1, FALSE,
    "Girls", "P6", 4, "health2", 2, "Health var 2", 0.5, TRUE,
  )
  expected_p7 <- tibble::tribble(
    ~gender, ~class, ~denom, ~var, ~n, ~labels, ~prop, ~censored,
    "Boys", "P7", 4, "health1", 3, "Health var 1", 0.75, FALSE,
    "Boys", "P7", 4, "health2", 2, "Health var 2", 0.5, TRUE,
    "Girls", "P7", 4, "health1", 2, "Health var 1", 0.5, TRUE,
    "Girls", "P7", 4, "health2", 0, "Health var 2", 0, TRUE,
  )
  expected_all <- tibble::tribble(
    ~gender, ~class, ~denom, ~var, ~n, ~labels, ~prop, ~censored,
    "All", "All", 16, "health1", 11, "Health var 1", 11 / 16, FALSE,
    "All", "All", 16, "health2",  5, "Health var 2", 5 / 16, FALSE,
  )

  expected_all_oneclass <- tibble::tribble(
    ~gender, ~class, ~denom, ~var, ~n, ~labels, ~prop, ~censored,
    "All", "All", 8, "health1", 5, "Health var 1", 5 / 8, FALSE,
    "All", "All", 8, "health2",  2, "Health var 2", 0.25, TRUE,
  )
  ...
  expected_all_one_not_declared <- tibble::tribble(
    ~gender, ~class, ~denom, ~var, ~n, ~labels, ~prop, ~censored,
    "All", "All", 17, "health1", 12, "Health var 1", 12 / 17, FALSE,
    "All", "All", 17, "health2",  6, "Health var 2", 6 / 17, FALSE,
  )
